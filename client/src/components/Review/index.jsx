...
const Review = ({ username, content, rating, onDelete, gameName, imageUrl, gameId }) => {
...
<div className="review__image-container">
        {imageUrl && (
          <img className="review__image" src={imageUrl} alt={`${gameName} cover`} onClick={handleOnClick} />
        )}
     </div> 
